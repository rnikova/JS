function solve() {
    let [titleInput, yearInput, priceInpit] = Array.from(document.querySelectorAll('input'));
    let addBtn = document.querySelector('button');
    let totalProfitHearder = Array.from(document.querySelectorAll('h1'))[1];
    ...
    addBtn.addEventListener('click', function (e) {
        ...
        let price = Number(priceInpit.value);
    ...
    function createBook(isOld, title, year, price, shelf) {
        ...
        buyBtn.addEventListener('click', function (e) {
            ...
            totalProfitHearder.textContent = `Total Store Profit: ${totalSum.toFixed(2)} BGN`;
        })
